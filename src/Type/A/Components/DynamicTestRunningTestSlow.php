    ...
    protected static function createElements(): array
    {
        return [
            ...
            [
                ...
                new Input('incoming_speed_1_min_r-s', ''),
            ...
            [
                ...
                new Input('incoming_speed_1_min_r-t', ''),
                new Span(''),
                new Span(''),
                new Span(''),
                new Span(''),
            ...
            [
                ...
                new Input('incoming_speed_1_min_s-t', ''),
                new Span(''),
                new Span(''),
                new Span(''),
                new Span(''),
            ...
            [
                ...
                new Input('final_speed_1_min_r-s', ''),
            ...
            [
                ...
                new Input('final_speed_1_min_r-t', ''),
                new Span(''),
                new Span(''),
                new Span(''),
                new Span(''),
            ...
            [
                ...
                new Input('final_speed_1_min_s-t', ''),
                new Span(''),
                new Span(''),
                new Span(''),
                new Span(''),
